...
(default: /mnt/Volume/Ubuntu/3d_vision/results).
"""
...
RESULTS_ROOT = Path(os.environ.get("RESULTS_ROOT", "/mnt/Volume/Ubuntu/3d_vision/results"))

# Seconds to wait between launching gs_mapping and starting bag play.
# Increase if TRT engine loading is slow on your machine.
INIT_WAIT_S = 8

# Bag playback rate (1.0 = real time)
BAG_RATE = "1.0"
